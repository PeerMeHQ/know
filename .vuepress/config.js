  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        title: 'Features',
        collapsable: false,
        children: prefix('features', ['bot', 'events', 'log', 'bounties', 'kyc', 'accounting']),
      },
      {
        title: 'Developers',
        collapsable: false,
        children: prefix('developers', ['extensions', 'sdks', 'api', 'smart-contracts', 'clean-code']),
      },
    ],
    smoothScroll: true,
